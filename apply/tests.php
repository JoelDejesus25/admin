...
if ($isLoggedIn) {
    ...
    $sellerQuery = "SELECT seller_id FROM sellerapplication WHERE id = '$userId'";
...
<body>
    <?php 
     $sellerApplicantQuery = "SELECT * FROM sellerapplication WHERE id = '$userId'";
...
$(document).ready(function() {
    $('#applySellerForm').on('submit', function(e) {
        ...
        $.ajax({
            url: 'apply_as_seller.php', // URL to the PHP script that will handle the form submission
